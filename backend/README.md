...
## Project Structure
    ...
    ├── testapiautosetting_122976  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_122976`
...
2. Clone this repo and `cd testapiautosetting_122976`
